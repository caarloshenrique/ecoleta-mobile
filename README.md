...
Altere o endereço de IP no arquivo [api.ts](ecoleta-mobile/ecoleta-app/src/services/api.ts) localizado em `ecoleta-mobile/ecoleta-app/src/services/api.ts` para o endereço de IP exibido nos dados de conexão.
